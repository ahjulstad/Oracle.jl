...
@enum OraOracleTypeNum::UInt32 begin
    ...
    ORA_ORACLE_TYPE_JSON          = 2027
    ORA_ORACLE_TYPE_JSON_OBJECT   = 2028
    ORA_ORACLE_TYPE_JSON_ARRAY    = 2029
    ORA_ORACLE_TYPE_UROWID        = 2030
    ORA_ORACLE_TYPE_LONG_NVARCHAR = 2031
    ORA_ORACLE_TYPE_XMLTYPE       = 2032
    ORA_ORACLE_TYPE_VECTOR        = 2033
    ORA_ORACLE_TYPE_JSON_ID       = 2034
    ORA_ORACLE_TYPE_MAX           = 2035
end
...
@enum OraNativeTypeNum::UInt32 begin
    ...
    ORA_NATIVE_TYPE_JSON        = 3013
    ORA_NATIVE_TYPE_JSON_OBJECT = 3014
    ORA_NATIVE_TYPE_JSON_ARRAY  = 3015
    ORA_NATIVE_TYPE_NULL        = 3016
    ORA_NATIVE_TYPE_VECTOR      = 3017
